          ...
          <nav className="flex gap-4">
            {[
              ...
              <button
                ...
                className={`px-4 py-2 text-sm font-medium border-b-2 transition-all duration-300 font-display ${activeTab === tab.id
                  ? "border-sky-500"
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-border bg-card/90 p-8 shadow-lg shadow-black/5 dark:shadow-black/25 backdrop-blur">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Free Plan */}
                <div
                  className={`rounded-2xl border p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${org && 'plan' in org && org.plan === "free"
                ...
                {/* Pro Plan */}
                <div
                  className={`rounded-2xl border p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${org && 'plan' in org && org.plan === "pro"
                    ? "border-primary/60 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent dark:from-primary/20 dark:via-primary/10 dark:to-primary/5"
                    : "border-border bg-card/70 hover:bg-secondary/60"
                    }`}
                >
                ...
                {/* Enterprise Plan */}
                <div
                  className={`rounded-2xl border p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${org && 'plan' in org && org.plan === "enterprise"
                    ? "border-primary/60 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent dark:from-primary/20 dark:via-primary/10 dark:to-primary/5"
                    : "border-border bg-card/70 hover:bg-secondary/60"
                    }`}
                >
                ...
                {creditHistory.map((transaction) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <div
                        className={`text-sm font-semibold font-display ${transaction.amount > 0
                          ? "text-green-700"
                          : "text-red-700"
                          }`}
                      >
